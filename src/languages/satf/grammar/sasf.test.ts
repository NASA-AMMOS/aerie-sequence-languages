...
const tests = [
  ...
  [
    ...
    `satf_sasf(Sasf(Header,
      Body(
      Requests(
        Request(RequestName,Requestor,Processor,Key,StartTime(Time)
  ...
  [
    ...
    `satf_sasf(Sasf(Header,Body(
      Requests(
        Request(RequestName,Requestor,Processor,StartTime(Time,TimeRelation),Key,
          Steps(Command(StepLabel,ScheduledTime(Time,TimeRelation),Comment,Stem,Args(String)))),
        Request(RequestName,StartTime(Time),Requestor,Processor,Key,
